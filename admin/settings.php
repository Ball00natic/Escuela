...
<centre><div class="w3-main w3-half w3-row-padding" style="margin-left:305px">
      ...
      <br>
      <br>
      <h4><b>ACTUALIZA TUS DATOS</b></h4>
      <h4><b>Imagen</b></h4>
      <center><img src="../img/<?php echo $_SESSION["user_img"];?>" style="width:100px;" class="w3-round">
      <form enctype="multipart/form-data" action="uploader.php" method="POST">
      <input class="w3-button" name="uploadedfile" type="file" />
      <button class="w3-button" type="submit">Subir archivo</button>
      </form></center>
      <?php $id1=$_SESSION["user_id"];?>
      <form role="form" name="registro" action="../php/configuracion.php" method="post">
        <div class="form-group">
        <div class="form-group">
          <input type="hidden" class="form-control" id="id" name="id" value="<?php echo "$id1" ?>">
          </div>
        ...
        <div class="form-group">
          <label for="password1">Contrase&ntilde;a actual</label>
          <input type="password" class="form-control" id="password" name="password1" placeholder="Contrase&ntilde;a" required>
        </div>
